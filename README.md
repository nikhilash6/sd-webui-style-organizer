...
| 📦 | **Presets** — save/load/delete style sets. Load updates the host and notifies the V2 iframe (`SG_CLEAR_SELECTION` / `SG_STYLE_APPLIED`) so the bottom selected bar matches the preset. |
